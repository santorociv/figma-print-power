...
const Index = () => {
  ...
  return (
    <PrintSettingsProvider>
      <div className="min-h-screen flex flex-col bg-gray-50" style={{ height: '100vh' }}>
        ...
        <div 
          className="flex-1 flex flex-col md:flex-row w-full p-4 gap-6"
          style={{ height: `calc(${containerHeight}px - 80px)`, minHeight: 0 }}
        >
          <div 
            className="md:w-[calc(33.33%+40px)] flex flex-col"
              ...
              <TabsList className="grid grid-cols-2 mb-4">
                <TabsTrigger value="create" className="flex items-center justify-center">
                  <span className="flex items-center">
                    <svg className="mr-1 h-4 w-4" viewBox="0 0 24 24" fill="none"><path d="M12 5v14m7-7H5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg>
                    <span>Create</span>
                  </span>
                </TabsTrigger>
                <TabsTrigger value="export" className="flex items-center justify-center">
                  <span className="flex items-center">
                    <svg className="mr-1 h-4 w-4" viewBox="0 0 24 24" fill="none"><path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2M7 12l5 5 5-5M12 17V3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                    <span>Export</span>
                  </span>
                </TabsTrigger>
              </TabsList>
          ...
          <div 
            ...
            className="md:w-[calc(66.67%-40px)] min-h-0 flex flex-col"
            style={{ height: '100%', minHeight: 0 }}
          >
